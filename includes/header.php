...
?>
  ...
  <nav id="nav">
      <ul>
          <li><a href="agregar_incidencia.php">Agregar incidencia</a></li><li><a href="listado_incidencias.php">Ver incidencias</a></li><li><a href="listado_admision.php">Admisión</a></li>
      </ul>
  </nav>
